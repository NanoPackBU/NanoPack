...
def check_font(font=FONT):
    ...
    if not font.exists() and not (CONFIG_DIR / font.name).exists():
        ...
        print(f'Downloading {url} to {CONFIG_DIR / font.name}...')
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolov5s.pt', device=None, dnn=False, data=None):
        ...
        super().__init__()
        w =  weights
        pt, jit, onnx, xml, engine, coreml, saved_model, pb, tflite, edgetpu, tfjs = self.model_type(weights)  # get backend
        ...
        if pt:  # PyTorch
            ...
            print('error with model load possibily due to modifications revert the detectMOD file to before DetectMultiBackend was added')
...
def check_pil_font(font=FONT, size=10):
    ...
    try:
        ...
        try:
            ...
            print("Requirements error")  # known issue https://github.com/ultralytics/yolov5/issues/5374
...
def run(GKSPERAM,# not very functionall... GKS MOD
    ...
    # Directories
    save_dir = Path(project) / "output"  # increment run
    ...
    names, pt, jit, onnx, engine =  model.names, model.pt, model.jit, model.onnx, model.engine
    ...
    dataset =LoadImages(source, img_size=imgsz, stride=model.stride, auto=pt,imgIN=GKSPERAM)
    bs = 1  # batch_size
    # Run inference
